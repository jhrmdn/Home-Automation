...
import mdn.jh.automation.io.logic.components.number.NumericThresholdSwitch;
import mdn.jh.automation.io.logic.components.number.PidController;
...
//	FritzBox fritzBox = null;
	...
	private void initComponentSelection() {
		...
		addButtonToBooleanSelection("Threshold switch", NumericThresholdSwitch.class);
		addButtonToBooleanSelection("PID controller", PidController.class);
