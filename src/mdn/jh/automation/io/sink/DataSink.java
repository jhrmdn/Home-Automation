...
import mdn.jh.automation.storage.ConfigurationManager;
...
public abstract class DataSink extends DataComponentStub implements DataInputIF, Storeable {
	...
	private transient boolean actionsSuppressed;
...
*/
	...
	*/
	...
	public void executeActions() {
		if (actionsSuppressed) { myOutput.setValue("suppressed in development mode"); myOutput.setDataValid(true); fireUpdate(); return; }
		updateCycle();
		fireUpdate();

	}

	public boolean isActionsSuppressed() { return actionsSuppressed; }
	public void setActionsSuppressed(boolean actionsSuppressed) { this.actionsSuppressed = actionsSuppressed; }
