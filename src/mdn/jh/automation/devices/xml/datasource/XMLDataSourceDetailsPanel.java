...
public class XMLDataSourceDetailsPanel extends JPanel {
	...
	public void setXMLDataSource(XMLDataSource dataSource) {
		...
		getParameterEditorSourceParameter().setObjectToEdit(dataSource.getXpath());
	...
	public XMLDataSourceDetailsPanel() {
	...
	public XMLDataSourceDetailsPanel(LayoutManager layout) {
		super(layout);
		// TODO Auto-generated constructor stub
	}

	public XMLDataSourceDetailsPanel(boolean isDoubleBuffered) {
		super(isDoubleBuffered);
		// TODO Auto-generated constructor stub
	}

	public XMLDataSourceDetailsPanel(LayoutManager layout, boolean isDoubleBuffered) {
	...
	private JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			lblNewLabel = new JLabel("XML Data Source Details");
		}
		return lblNewLabel;
	}
